...
class CellPhoneAuthSigninState extends State<CellPhoneAuthSignin>
  ...
  void _processSignIn() async {
    ...
    try {
      ...
      final resultUser = await _danceWithFirebase();
      pp('\n$mm user signed in to firebase? result: ${resultUser.name}');
      user = await prefs.getUser();

      if (mounted) {
        pp('\n$mm getting data before popping ......................');
        await listApiDog.getAssociationUsers(resultUser.associationId!);
        await listApiDog.getAssociationVehicles(
            resultUser.associationId!, true);

        pp('\n$mm routesIsolate.getRoutes ......................');
        await routesIsolate.getRoutes(resultUser.associationId!);
        pp('\n$mm  data download complete. ... popping ......................');
  ...
  Future<lib.User> _danceWithFirebase() async {
